jQuery(function($) {
  ...
  new Chart(document.getElementById('infobox-chart1'), {
    data: {
        labels: ["Jan", "Feb", "Mar", "Apr", "May", "June", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
        datasets: [
            {
              type: 'line',
              data: [1000,800,1800,400,1500,1000,1050,1300,2100,1400,1500,1350],
  ...
  new Chart(document.getElementById('task-progress-piechart'), {
    type: 'doughnut',
    data: {
        datasets: [{
            label: 'Task Progress',
  ...
  if(trafficSourceChart_Legends_Wrapped) {
    ...
    demographicsChart.height = parseInt(demographicsChart.parentNode.offsetHeight * 0.66);
  }
