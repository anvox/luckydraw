  ...
  var Basic = /*#__PURE__*/function () {
    ...
    _createClass(Basic, null, [{
      ...
      value: function _handleDropdowns() {
        ...
        $__default['default'](document).on('shown.bs.dropdown', '.dropdown.dd-backdrop', function (e) {
          // check `display` of .dropdown::before
          ...
          $__default['default'](this).one('hidden.bs.dropdown', function (e) {
      ...
      key: "_handleTabScrollAndSwipe",
      value: function _handleTabScrollAndSwipe() {
        ...
        var _scrollIntoView = function _scrollIntoView() {
          ...
          if (!isRTL) {
            _scrollLeft = li.offsetLeft - (navClientWidth - li.clientWidth) / 2; // if (_scrollLeft < 0) _scrollLeft = 0
          } else {
            // firefox and webkit have different way of dealing with scrolling right/left and offsets in RTL mode
            if (!_firefox) {
              _scrollLeft = navScrollWidth - navClientWidth + li.offsetLeft - (navClientWidth - li.clientWidth) / 2; // if (_scrollLeft > navScrollWidth) _scrollLeft = navScrollWidth
            } else {
              _scrollLeft = li.offsetLeft - (navClientWidth - li.clientWidth) / 2; // var diff = navClientWidth - navScrollWidth
        ...
        var aceTabScroll = function aceTabScroll() {
        ...
        $__default['default'].fn.aceTabScroll = aceTabScroll;
        $__default['default']('.nav-tabs-scroll').each(function () {
          $__default['default'](this).aceTabScroll();
        }); /// /
        // tab pane swiping

        var aceTabSwipe = function aceTabSwipe() {
          var allowedDir = $__default['default'](this).attr('data-swipe') || null;
          this.on('touchstart', '.tab-pane', function (ev) {
            ...
            function _dismiss() {
              $__default['default'](curPane).off('touchmove touchend touchcancel');
            ...
            $__default['default'](this).on('touchmove', function (ev) {
              ...
              if (swipeDir === 0) {
                ...
                if (diffY > diffX) {
                  ...
                  $__default['default'](curPane).off('touchmove');
                } else if (diffX > 10) {
            ...
            .on('touchend touchcancel', function (ev) {
              ...
              if (curDir !== 0 && swipeDir === 1 && (diff > paneWidth / 4 || diff > 100 || diff > paneWidth / 6 && t2 - t1 < 300)) {
                ...
                $__default['default']('[href="#' + id1 + '"],[data-target="#' + id1 + '"]').removeClass('active');
                var newActive = $__default['default']('[href="#' + id2 + '"],[data-target="#' + id2 + '"]');
        ...
        $__default['default'].fn.aceTabSwipe = aceTabSwipe;

        if ('ontouchstart' in window) {
          $__default['default']('.tab-sliding:not([data-swipe="none"])').each(function () {
            $__default['default'](this).aceTabSwipe();
          });
        }
      }
    }, {
      ...
      value: function _handleSticky() {
        ...
        var aceStickyNav = function aceStickyNav() {
          var stickyEl = this.get(0); // add a dummy child to watch
        ...
        $__default['default'].fn.aceStickyNav = aceStickyNav;
        $__default['default']('[class*="sticky-nav"]').each(function () {
          $__default['default'](this).aceStickyNav();
        });
      } /// ////////
      ...
      value: function _handleOther() {
        $__default['default']('.input-floating-label input').each(function () {
          if (this.value !== '') this.classList.add('has-content');else this.classList.remove('has-content');
        });
        $__default['default'](document).on('focusout', '.input-floating-label input', function (e) {
          if (this.value !== '') this.classList.add('has-content');else this.classList.remove('has-content');
        });
      }
    }]);
      ...
      value: function _HandleAside() {
        ...
        $__default['default'](document).on('show.bs.modal', '.modal', function (e) {
          ...
          if (modal.classList.contains('modal-nb')) {
            ...
            if (backdropBg) {
              setTimeout(function () {
                $__default['default']('.modal-backdrop').addClass(backdropBg);
              }, 0);
            }
            ...
            if (blur !== null && window.CSS) {
              /**
               ...
               if (window.CSS.supports("backdrop-filter", "none")) {
                setTimeout(function () {
                  $('.modal-backdrop').addClass('modal-blur')
                }, 0)
              }
              else */
    ...
    _createClass(Toaster, [{
      ...
      value: function add(config) {
        ...
        if (_config.progress && !_config.sticky && _config.autohide !== false) {
          ...
          progress.get(0).style.transition = "width ".concat(parseInt(_config.delay * 1.01), "ms linear");
          progress.get(0).style.width = _config.progressReverse ? '100%' : 0; // progress.get(0).offsetWidth

          setTimeout(function () {
            progress.get(0).style.width = _config.progressReverse ? 0 : '100%';
          }, 0);
        }
              ...
              case 'backColor':
                ...
                for (var color in button.values) {
                  if (Object.prototype.hasOwnProperty.call(button.values, color)) {
                    toolbarHtml += " <div class=\"dropdown-item p-0 d-inline-block w-auto\"><a class=\"p-0 dh-zoom-3\" role=\"button\" data-edit=\"".concat(button.name, " ").concat(button.values[color], "\" style=\"width:1.25rem;height:1.25rem;background-color:").concat(button.values[color], ";\"></a></div> ");
                  }
                }
